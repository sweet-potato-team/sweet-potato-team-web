...
// import React, { useEffect, useRef, useState, useCallback } from 'react';
// import axios from "axios";
// import SpaceRentalModal from "../../components/admin/SpaceRentalModal"; // 引入新的 Modal 组件
// import DeleteModal from "../../components/DeleteModal"; // 引入DeleteModal组件
// import Pagination from "../../components/Pagination";
// import { Modal } from "bootstrap";
// import ActionButtonsRentals from "../../components/admin/ActionButtonsRentals";  // 引入 ActionButtonsRentals 组件
...
//     } catch (error) {
//       console.error("Error fetching space rentals:", error);
//       setDeleteErrorMessage('資料獲取失敗，請稍後再試');
...
//     } catch (error) {
//       console.error("Error updating rental status:", error);
//       setDeleteErrorMessage('更新失敗，請稍後再試');
//       setDeleteModalOpen(true);
//     }
//   };
...
//       } catch (error) {
//         console.error("Error deleting rental:", error);
//         setDeleteErrorMessage('刪除失敗，請稍後再試');
//         setDeleteModalOpen(true);
//       }
//     }
//   };
...
//     { value: 'spaceRentalEmail', label: '電子郵件' },
//     { value: 'spaceRentalPhone', label: '聯絡電話' },
//     { value: 'spaceRentalDateStart', label: '租借起始時間' },  // 更新
//     { value: 'spaceRentalDateEnd', label: '租借結束時間' },  // 更新
//     { value: 'spaceRentalReason', label: '申請理由' },
//     { value: 'spaceRentalAgree', label: '申請者同意' },
//     { value: 'spaceRentalSuccess', label: '是否通過' },
//     { value: 'freeSpaceName', label: '空間名稱' }
