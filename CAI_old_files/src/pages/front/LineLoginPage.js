  ...
  useEffect(() => {
    ...
    if (code) {
      fetch('http://localhost:8080/api/lineLogin/token', {
        ...
        .finally(() => {
          setIsLoading(false);  // 當資料加載完成，將 isLoading 設置為 false
        })
      ...
      <div style={{ flex: 1 }}>
        ...
        {!isLoading && userData ? (
          <>
            ...
            <div style={styles.sectionContainer}>
              <Section ref={infoRef} title="個人資訊" backgroundColor="#D3C8BB"
                onSendClick={({ start, end }) => {
...
//           // Determine the avatar based on gender and age
//           const basePath = '/images/';
//           let avatarPath = 'boy_young.png'; // Default
//           if (userInfo.gender === '女') {
//             avatarPath = userInfo.age > 40 ? 'girl_older.png' : 'girl_young.png';
...
//       cursor: 'pointer',
//       transition: 'transform 0.2s, box-shadow 0.2s',
//       boxShadow: '4px 4px 6px rgba(0,0,0,0.2)', // 添加阴影，4px 右偏移，4px 下偏移
